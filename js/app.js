...
let targetNow = document.querySelector('main section:nth-child(1) p')
let targetIn3Hours = document.querySelector('main section:nth-child(2) p')
let targetTomorrow = document.querySelector('main section:nth-child(3) p')
